...
int Game::menu()
{
    ...
    menuSurface = SDL_GetWindowSurface(window);
    imageSurface = SDL_LoadBMP("Boat.bmp");
    //black = SDL_CreateRGBSurface(0, SCREEN_WIDTH, SCREEN_HEIGHT, 32, 0, 0, 0, 0x);
    music = Mix_LoadMUS( "MenuSound.wav" );
    musicHax = Mix_LoadMUS( "DemHax.wav" );
    ...
    SDL_BlitSurface(imageSurface, NULL, menuSurface, NULL);
    SDL_UpdateWindowSurface(window);
...
void Game::Lv1()
{
    ...
    SDL_Texture* Background = graphics.loadTexture("Blue.png", renderer);
    SDL_Texture* obst =  graphics.loadTexture("Iceberg.png", renderer);
    SDL_Texture* enemytx =  graphics.loadTexture("enemyboat.png", renderer);
    SDL_Texture* frietx =  graphics.loadTexture("pingo.png", renderer);


    SDL_Texture* Player = graphics.loadTexture("playerboat.png", renderer);
...
void Game::Lv2()
{
    ...
    SDL_Texture* Background = graphics.loadTexture("Green.png", renderer);
    SDL_Texture* obst =  graphics.loadTexture("Lilipad.png", renderer);
    SDL_Texture* enemytx =  graphics.loadTexture("enemyboat.png", renderer);
    SDL_Texture* frietx =  graphics.loadTexture("zabika.png", renderer);
...
void Game::Lv3()
{
    ...
    SDL_Texture* Background = graphics.loadTexture("Orange.png", renderer);
    SDL_Texture* obst =  graphics.loadTexture("crystal.png", renderer);
    SDL_Texture* enemytx =  graphics.loadTexture("enemyboat.png", renderer);
    SDL_Texture* frietx =  graphics.loadTexture("ribica.png", renderer);

    SDL_Texture* doggo = graphics.loadTexture("seadoggo.png", renderer);
